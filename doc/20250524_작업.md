...
# 2025.07.05
브라우저 라우터 배포
라우터 페이지에서 새로고침할 경우 현재 경로를 잃어버림
해시 라우터 배포

package.json
"homepage": "https://sangholee1990.github.io/green"
"homepage": "http://shlee1990.dothome.co.kr/blue"
...
4. design 디자인
1) 입력폼, 입력상자 박스
    - 고유번호 idx 자동증가번호 AUTO_INCREMENT  AI
    - 날짜, 시간 입력 상자       
    - 입력상자
    - 저장 버튼
