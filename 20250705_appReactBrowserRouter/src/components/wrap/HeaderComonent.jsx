    ...
    <>
        <header id="header">
            <div className="row1">
                ...
                <h1><Link to="/home" title={state.로고}><span>{state.로고.slice(0,2)}</span><em>{state.로고.slice(2)}</em></Link></h1>
            </div>
            <div className="row2">
                <nav id="nav"  onMouseLeave={onMouseLeaveNav}>
                    ...
                    state.GNB.map((item,i)=>{
                        ...
                        <li><Link to="/sub1" className="main-btn">서브페이지1</Link></li>
                        <li><Link to="/sub2" className="main-btn">서브페이지2</Link></li>
                        <li><Link to="/sub3" className="main-btn">서브페이지3</Link></li>
                        <li><Link to="/sub4" className="main-btn">서브페이지4</Link></li>
                    </ul>
                </nav>
            </div>
        </header>
